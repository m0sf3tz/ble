...
#define SAMPLE_DEVICE_NAME          "TERA_FIRE_GUARD"
...
static esp_ble_adv_data_t adv_data = {
    ...
    .appearance          = 0x00,
    .manufacturer_len    = sizeof(device_id),    
    .p_manufacturer_data = device_id,
    .service_data_len    = 0,
    .p_service_data      = NULL,
...
static const esp_gatts_attr_db_t gatt_db[IDX_FINAL] =
{
    ...
    [IDX_VAL_A] =
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_TERA_FIRE, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
...
static void gatts_profile_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    switch (event) {
        ...
        case ESP_GATTS_CREAT_ATTR_TAB_EVT:{
            if (param->add_attr_tab.status != ESP_GATT_OK){
                ...
                ESP_LOGE(GATTS_TABLE_TAG, "create attribute table abnormally, num_handle (%d) \
                        doesn't equal to IDX_FINAL(%d)", param->add_attr_tab.num_handle, IDX_FINAL);
            }
            else {
        ...
        case ESP_GATTS_ADD_CHAR_EVT:
             ESP_LOGE(GATTS_TABLE_TAG, "added some shit boss");
             exit(1);
        default:
            break;
    }
